  ...
  return (
    <div className="mx-auto max-w-4xl pb-32">
      ...
      <div className="pointer-events-none fixed inset-x-0 bottom-0 z-40 flex items-center justify-center gap-2.5 pb-[calc(0.7rem+var(--tg-safe-area-inset-bottom,0px))]">
        ...
        {/* New Report — isolated, background matches active highlight */}
        <button
          type="button"
          onClick={() => setShowTemplateSelection(true)}
          className="glass-floating pointer-events-auto flex h-[60px] w-[60px] items-center justify-center rounded-full text-muted-foreground transition-colors hover:text-foreground active:scale-[0.98]"
        >
