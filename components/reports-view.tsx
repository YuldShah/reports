...
export default function ReportsView() {
  ...
  const fetchData = async () => {
    try {
      ...
      const reportsWithDates = (reportsData.reports || []).map(
        (report: any) => ({
          ...report,
      ...
      const templatesWithDates = (templatesData.templates || []).map(
        (template: any) => ({
          ...template,
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-between">
        ...
        {sheetConfigured && sheetUrl ? (
          <Button
            asChild
            variant="outline"
            className="bg-[#0f9d58] hover:bg-[#0d8a4e] text-white border-[#0f9d58] transition-transform active:scale-95 shadow-md hover:shadow-lg"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="relative">
              ...
              <Input
                ...
                className="h-9 pl-10 transition-colors focus:border-primary"
              />
            </div>
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="text-sm text-muted-foreground">
          Showing {filteredReports.length > 0 ? startIndex + 1 : 0}-
                    ...
                    <CardHeader className="pb-3">
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1 space-y-1 min-w-0">
                          <CardTitle className="font-heading text-lg leading-tight truncate">
                            {normalizeText(report.title)}
                          </CardTitle>
